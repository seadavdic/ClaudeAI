...
└──────┬───────┘
       │
       │ 1. DNS: grafana.local → <cluster-ip>
       │    (from hosts file)
       │
       ▼
┌──────────────────────┐
...
└─────────────────────────────────────────────────────────────────┘
  ...
  └─ ✅ Solution: Change to master IP (k3s-master: <master-ip>)
